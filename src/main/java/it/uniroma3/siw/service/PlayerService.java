...
public class PlayerService {
    ...
    @Transactional(readOnly = true)
    public Page<Player> searchPlayersPaginated(String search, String role, boolean onlyFreeAgents, int page, int size) {
        return playerRepository.findFilteredPlayersPaginated(search, role, onlyFreeAgents, PageRequest.of(page, size));
    }
