...
public class MatchService {
	...
	@Transactional(readOnly = true)
	public Page<Match> searchMatchesPaginated(String search, LocalDate startDate, LocalDate endDate, int page, int size) {
	    LocalDateTime start = startDate != null ? startDate.atStartOfDay() : null;
	    LocalDateTime end = endDate != null ? endDate.atTime(23, 59, 59) : null;
	    return matchRepository.findFilteredMatchesPaginated(search, start, end, PageRequest.of(page, size));
	}
