		...
		http.authorizeHttpRequests(authorize -> authorize
			...
			.formLogin(form -> form
				...
				.successHandler((request, response, authentication) -> {
			        String refererUrl = (String) request.getSession().getAttribute("SPRING_SECURITY_SAVED_REQUEST_REFERER");
			        if (refererUrl != null) {
			            request.getSession().removeAttribute("SPRING_SECURITY_SAVED_REQUEST_REFERER");
